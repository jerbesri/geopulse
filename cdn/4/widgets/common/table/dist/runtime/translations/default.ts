export default {
  ...
  noSelectionTips: 'No features are selected in {layer}.',
  noColumnsTips: 'No columns are visible. Toggle on one or more columns to view the data.',
  selectSheet: 'Select a sheet to display',
  noLayersAvailable: 'No layers or tables are currently available to display.'
}
