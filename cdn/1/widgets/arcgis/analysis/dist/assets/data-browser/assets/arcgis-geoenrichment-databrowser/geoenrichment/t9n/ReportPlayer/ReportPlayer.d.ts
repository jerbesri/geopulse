...
export default interface ReportPlayerMessages {
  ...
  LocatorTableInfographic: {
    ...
    closestLocationsNtoMTableNofM: string;
  ...
  ExportDialog: {
    ...
    splitPages: string;
    combineSheets: string;
    exportExcelMaps: string;
    includeExcelDataDrilling: string;
    includeStaticDataDrilling: string;
    predefinedPanelsTooltip: string;
    PlayerViewModeOptions: {
      selectDefaultViewMode: string;
      auto: string;
      fullPage: string;
      stack: string;
      slide: string;
  ...
  ExportCommands: {
    ...
    exportedMapUnavailableLimit_1: string;
    exportedMapUnavailableLimit_2: string;
    locatorPagesLimit: string;
    PanelInfoCollector: {
      chartTitle: string;
