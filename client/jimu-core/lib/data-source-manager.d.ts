...
export declare class DataSourceManager {
    ...
    private readonly selectionChangePublishTimers;
    private readonly filterChangePublishTimers;
    private readonly filterChangePublishTasks;
    /**
    ...
    private onStoreDataSourcesInfoChange;
    private areWidgetQueriesCleared;
    private isWidgetQueryCleared;
    ...
    private listenToPostMessageForDs;
}
/**
 * @ignore
 */
