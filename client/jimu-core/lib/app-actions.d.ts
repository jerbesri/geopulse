...
import type { IMState, AppContext, AppRuntimeInfo, IMJimuMapViewInfo, SectionNavInfo, IMDataSourceInfo, IMMapWidgetInfo, DialogInfos, DataSourceInfo, DynamicStyleWidgetPreviewRepeatedRecordInfo, RuntimeError, RuntimeErrors, SystemError, SystemErrorType } from './types/state';
...
import type { ColorSchemeMode } from 'jimu-theme';
export declare enum ActionKeys {
    ...
    ChangeDataSourceHistoricMoment = "CHANGE_DATA_SOURCE_HISTORIC_MOMENT",
    ...
    RuntimeErrorChanged = "RUNTIME_ERROR_CHANGED",
    RuntimeErrorsChanged = "RUNTIME_ERRORS_CHANGED",
    SetSystemError = "SET_SYSTEM_ERROR",
    ClearSystemError = "CLEAR_SYSTEM_ERROR",
...
export interface ChangeDataSourceHistoricMomentAction extends UnknownAction {
    type: ActionKeys.ChangeDataSourceHistoricMoment;
    dataSourceId: string;
...
export interface ChangeThemeModeAction extends UnknownAction {
    type: ActionKeys.ChangeThemeMode;
...
export interface RuntimeErrorsChangedAction extends UnknownAction {
    type: ActionKeys.RuntimeErrorsChanged;
    runtimeErrors: RuntimeErrors;
}
export interface RuntimeErrorChangedAction extends UnknownAction {
    type: ActionKeys.RuntimeErrorChanged;
    runtimeError: RuntimeError;
    remove: boolean;
}
export interface SetSystemErrorAction extends UnknownAction {
    type: ActionKeys.SetSystemError;
    systemError: SystemError;
}
export interface ClearSystemErrorAction extends UnknownAction {
    type: ActionKeys.ClearSystemError;
...
export interface SetNoPermissionPagesAction extends UnknownAction {
    type: ActionKeys.SetNoPermissionPages;
    pages: Array<{
        id: string;
        label: string;
        isDefault: boolean;
...
export declare function widgetRuntimeInfoChange(widgetId: string, prop: string, value: any): WidgetRuntimeInfoChangeAction;
/**
...
export declare function changeDataSourceHistoricMoment(dataSourceId: string, historicMoment: string | number): ChangeDataSourceHistoricMomentAction;
...
export declare function ThemeModeChanged(value: ColorSchemeMode): ChangeThemeModeAction;
...
export declare function userLocaleChanged(locale: string, translatedLocale: string, isRTL: boolean): UserLocaleChangedAction;
export declare function runtimeErrorsChanged(runtimeErrors: RuntimeErrors): RuntimeErrorsChangedAction;
export declare function runtimeErrorChanged(runtimeError: RuntimeError, remove?: boolean): RuntimeErrorChangedAction;
export declare function setSystemError(systemError: SystemError): SetSystemErrorAction;
export declare function clearSystemError(systemErrorType: SystemErrorType): ClearSystemErrorAction;
...
export declare function setNoPermissionPages(pages: Array<{
    id: string;
    label: string;
    isDefault: boolean;
}>): SetNoPermissionPagesAction;
export {};
