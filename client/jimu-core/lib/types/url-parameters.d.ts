...
export interface UrlParameters {
    ...
    /**
     * post_message = <true | 1> to enable post message.
     * When enabled, the app will post message to the parent window if it's embedded in an iframe.
     */
    post_message?: string;
    /** listen_exb_message = <true | 1> to enable listening for post message.
     * When an app (any type app) is embedded in an ExB app and this URL param is enabled, the app can listen to messages from the ExB app.
     */
    listen_exb_message?: string;
}
