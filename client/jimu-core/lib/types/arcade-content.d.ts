...
import type { ArcGISQueryParams, FeatureLayerDataSource, OrientedImageryLayerDataSource, SubtypeGroupLayerDataSource, SubtypeSublayerDataSource, KnowledgeGraphSublayerDataSource } from '../data-sources';
import type { FillType } from 'jimu-ui';
export type ArcadeDataSource = FeatureLayerDataSource | OrientedImageryLayerDataSource | SubtypeGroupLayerDataSource | SubtypeSublayerDataSource | KnowledgeGraphSublayerDataSource;
...
export declare enum ArcadeContentType {
    CustomArcadeField = "CUSTOM_ARCADE_FIELD",
    MapViewerArcadeField = "MAP_VIEWER_ARCADE_FIELD",
    NormalFeature = "NORMAL_FEATURE",
...
export interface ArcadeProfileWithBundle extends __esri.Profile {
    bundles?: string[];
}
export interface ArcadeProfileContext {
    type: ArcadeProfileType;
    profile: ArcadeProfileWithBundle;
