...
export interface DynamicBackgroundStyle extends BackgroundStyle {
    contentColor?: string;
}
export type IMDynamicBackgroundStyle = ImmutableObject<DynamicBackgroundStyle>;
...
export interface DynamicStyleBackgroundEditorOptions {
    hasForeground?: boolean;
}
export type IMDynamicStyleBackgroundEditorOptions = ImmutableObject<DynamicStyleBackgroundEditorOptions>;
export interface DynamicStyleEditorOptions {
    [DynamicStyleType.Background]?: DynamicStyleBackgroundEditorOptions;
}
export type IMDynamicStyleEditorOptions = ImmutableObject<DynamicStyleEditorOptions>;
