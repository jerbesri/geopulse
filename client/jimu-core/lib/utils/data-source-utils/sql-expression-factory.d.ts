 ...
 * Create a SQLClause.
 */
export declare function createSQLClause(fieldName: string, operator: ClauseOperator, value: ClauseValuePair[], caseSensitive?: boolean, inputEditor?: string): SqlClause;
/**
