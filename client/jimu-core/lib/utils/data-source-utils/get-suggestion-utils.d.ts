 ...
 * Query suggestion
*/
export declare function getSuggestions(queryParams: any, option: QuerySuggestionParams, maxSuggestions?: number, isFullTextSearch?: boolean, shouldIncludeKeywords?: boolean): Promise<Suggestion[]>;
