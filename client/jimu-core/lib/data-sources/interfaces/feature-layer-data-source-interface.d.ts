...
export interface FeatureLayerDataSource extends ArcGISQueriableDataSource {
    ...
    queryRelatedRecords: (relatedDataSource: FeatureLayerDataSource, ids: Array<string | number>, params?: ArcGISQueryParams, ignoreFilter?: boolean) => Promise<RelatedRecordGroup[]>;
