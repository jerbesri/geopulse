...
export declare enum DataSourceTypes {
    ...
    /**
     * Knowledge graph layer data source is created from the knowledge graph service, it allows you to visualize and analyze knowledge graph data.
     */
    KnowledgeGraphLayer = "KNOWLEDGE_GRAPH_LAYER",
    /**
     * Child data source of KnowledgeGraphLayer
     */
    KnowledgeGraphSublayer = "KNOWLEDGE_GRAPH_SUBLAYER",
    /**
 ...
 */
export declare const AllDataSourceTypes: typeof DataSourceTypes;
/**
* @deprecated
* We have moved the ArcGIS data source types to `jimu-core`.
*/
...
export declare enum SupportedServerTypes {
    ...
    KnowledgeGraphService = "KnowledgeGraphServer"
}
/**
...
export declare enum SupportedItemTypes {
    ...
    QuickCaptureProject = "QuickCapture Project"
}
/**
 ...
 */
export declare enum SupportedJSAPILayerTypes {
 ...
 */
export declare enum SupportedLayerTypesInWebMapSpec {
...
export declare enum SqlQuerySortOrder {
    Asc = "ASC",
    Desc = "DESC"
}
/**
...
export interface DataSource {
    ...
    getIdField: () => string;
    /** Return the data source unique ID fields. If the data source has both an object id field and unique id fields, the unique id fields take precedence. */
...
export interface QueriableDataSource extends DataSource {
    ...
    url?: string;
    /**
     * Whether the data source is hosted in AGOL.
     */
    isAGOLHosted: boolean;
    /**
     * Portal self info for the data source.
     */
    portalSelf?: any;
    /**
     * @ignore
     ...
     * If the data source has `uniqueIdFields`, will query by unique ID, otherwise query by object ID.
     * if `uniqueIdFields` are `['field1', 'field2']`, the id should be `'["field1Value1","field2Value1"]'`.
    */
     ...
     * If the data source has `uniqueIdFields`, will return unique IDs, otherwise return object IDs.
     */
 ...
 */
export type ArcGISFolderLayer = __esri.MapImageLayer | __esri.TileLayer | __esri.GroupLayer | __esri.Sublayer | __esri.BuildingSceneLayer | __esri.KnowledgeGraphLayer;
...
export declare enum DataSourceSelectionMode {
    New = "New",
 ...
 * JS API layer types.
 */
export declare enum JSAPILayerTypes {
