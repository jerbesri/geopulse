...
import type { FeatureProfileContext, ArcadeDataSource, SingleDataSourceProfileVariableInstances, ArcadeProfileWithBundle } from '../types/arcade-content';
import { type DataSource, type ArcGISQueriableDataSource } from '../data-sources';
...
export declare function createDataSourcesProfile(usedForArcadeEditor: boolean, dataSourceIds: string[]): ArcadeProfileWithBundle;
...
export declare function isDataSourceSupportedForArcade(dataSource: DataSource): boolean;
export declare function getArcadeDataSource(dataSourceId: string): ArcadeDataSource;
