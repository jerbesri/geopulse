...
export declare class DataRecordsSelectionChangeMessage implements Message {
    ...
    constructor(widgetId: string, records: DataRecord[], dataSourceIds: string[], dataSourceId?: string, backgroundTrigger?: boolean);
}
/**
...
export declare class DataSourceFilterChangeMessage implements Message {
    ...
    backgroundTrigger: boolean;
    /**
     * When a widget clears all filters for a ds,
     * 'filter-data-record-action' and 'select-data-record-action' need to reset the corresponding filters/selections.
     * Therefore, this property is used to notify which dataSource filters were cleared by the widget.
    */
    clearFilterDataSourceIds: string[];
    constructor(widgetId: string, dataSourceIds: string[], clearFilterDataSourceIds?: string[], dataSourceId?: string, backgroundTrigger?: boolean);
}
/**
 ...
 * For example: Map widget publishes this message when user click the locate tool.
 */
...
export declare class SelectDataRecordMessage implements Message {
    ...
    recordId: string;
    backgroundTrigger: boolean;
    constructor(widgetId: string, dataSourceId: string, recordId: string, backgroundTrigger?: boolean);
}
/**
...
export interface MessageAction {
    ...
    getInitialMessages?: (actionConfig?: any) => Message[];
    getOutputMessages?: (message: Message, actionConfig?: any) => Message[];
}
/** @ignore */
...
export declare abstract class AbstractMessageAction implements MessageAction {
    ...
    destroy(): any;
    onRemoveListen(messageType: MessageType, messageWidgetId?: string, messageDataSourceId?: string): any;
    getInitialMessages(actionConfig?: any): Message[];
    getOutputMessages(message: Message, actionConfig?: any): Message[];
