...
export type QueriableLayerType = __esri.FeatureLayer | __esri.SceneLayer | __esri.BuildingComponentSublayer | __esri.ImageryLayer | __esri.OrientedImageryLayer | __esri.SubtypeGroupLayer | __esri.SubtypeSublayer | __esri.KnowledgeGraphSublayer;
type QueriableLayerViewType = __esri.FeatureLayerView | __esri.SceneLayerView | __esri.BuildingComponentSublayerView | __esri.ImageryLayerView | __esri.KnowledgeGraphSublayerView;
/**
...
export interface JimuQueriableLayerViewOptions extends JimuLayerViewConstructorOptions {
    /**
    * layer may be one of the following types: `FeatureLayer`, `SceneLayer`, `BuildingComponentSublayer`, `ImageryLayer`, `OrientedImageryLayer`, `SubtypeGroupLayer`, `SubtypeSublayer` or `KnowledgeGraphSublayer`.
     */
    layer: QueriableLayerType;
}
...
export declare class JimuQueriableLayerView extends JimuLayerView {
    ...
    private isKnowledgeGraphSublayer;
    /**
     * @ignore
     */
     ...
     */
    selectFeatureById(id: number | string, record?: FeatureDataRecord | __esri.Graphic): Promise<void>;
    /**
     * See `selectFeatureById` for more details.
     */
    selectFeaturesByIds(ids: Array<number | string>, records?: FeatureDataRecord[]): Promise<void>;
    ...
    private getRecordsAndApiGraphicsByRecords;
    private removeFeaturesFromHighlightFeatureLayer;
    /**
     * @ignore
     */
    highlightFeatureById(id: number | string): void;
    /**
