 ...
 * Note, this methods will modify the geometry of the input features and return the input features.
 * @param view
 * @param dataSource
 * @param features
 * @returns
 */
export declare function updateFeaturesForRendering(view: __esri.View, dataSource: ArcGISQueriableDataSource, features: __esri.Graphic[]): Promise<{
...
export declare function isValidFeatureId(id: any): boolean;
export declare function addEventListener(element: HTMLElement, eventName: string, listener: (event: CustomEvent) => void): __esri.Handle;
export declare function watchPopupElementPropertyChange(popupElement: HTMLArcgisPopupElement, propertyName: string, listener: (event: CustomEvent) => void | Promise<void>, delayMillSeconds?: number): __esri.Handle;
/**
 * This method returns a promise that resolves when the specified property of the PopupElement changes.
 */
export declare function getPopupPropertyChangePromise(popupComponent: HTMLArcgisPopupElement, propertyName: string, timeout: number): Promise<void>;
export declare function getLayerFromFeature(feature: __esri.Graphic): any;
