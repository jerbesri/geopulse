...
import { JimuTable } from './layers/jimu-table';
...
/**
 * A MapTool is a ArcGIS JavaScript API widget instance or map component used in map widget.
 */
export interface JimuMapTool {
    /** The tool name, use the ArcGIS JavaScript API class name. */
    name: string;
    /** The instance of ArcGIS JavaScript API class or map component */
    element: __esri.Widget | HTMLArcgisHomeElement | HTMLArcgisZoomElement | HTMLArcgisLocateElement | HTMLArcgisCompassElement | HTMLArcgisScaleBarElement | HTMLArcgisLayerListElement | HTMLArcgisLegendElement | HTMLArcgisSearchElement | HTMLArcgisBasemapGalleryElement | HTMLArcgisNavigationToggleElement | HTMLArcgisTrackElement | HTMLElement;
}
/**
...
export interface JimuMapViewConstructorOptions {
    ...
    dataSourceId: string;
    /**
     * The arcgis-map or arcgis-scene web component for map rendering.
     */
...
type JimuMapViewUpdatingListener = (jimuMapView: JimuMapView, updating: boolean) => void;
...
export type JimuTableCreatedListener = (jimuTable: JimuTable) => void;
...
export declare class JimuMapView {
    ...
    /** The created map tools (ArcGIS JavaScript API widgets or map components) for this view. */
    ...
    private jimuTableCreatedListeners;
    private watchHandles;
    private watchBeforeAddLayerHandle;
    private watchAfterAddLayerHandle;
    private watchAfterRemoveLayerHandle;
    ...
    private releaseWatchLayerChangeHandles;
    private getRootAncestorLayer;
    /**
     * @ignore
     */
    getPopupElement(): HTMLArcgisPopupElement;
    private getPopupSelectedFeature;
    private watchPopupTriggerAction;
    /**
    ...
    private watchViewUpdating;
    private getCentroidOfFeature;
    /**
     ...
     * @ignore
     */
    openPopup(features: __esri.Graphic[]): Promise<void>;
    /**
     * @ignore
    ...
    /**
     * This method tries to select the hit feature.
     * The promise resolves to true if the hit feature is selected; otherwise, it resolves to false.
     */
    private selectHitTestFeature;
    private isMapServiceLayerPopupEnabled;
    /**
     * This method tries to identify the clicked feature and select it.
     * The promise resolves to true if the identified feature is selected; otherwise, it resolves to false.
     */
    ...
    /**
     * Return all created JimuLayerViews. This method will sort JimuLayerViews by layer rendering order.
     * The returned JimuLayerViews may not be loaded yet. If you want to get all the JimuLayerViews that have already been loaded, you can call the `jimuMapView.getAllLoadedJimuLayerViews()` method.
    ...
    /**
     * Return all loaded JimuLayerViews.
     */
     ...
     * @param parentJimuLayerId the layer's parent JimuLayer ID
     ...
     */
    createJimuLayerView(layerOrSubLayer: __esri.Layer | ArcGISSubLayer, parentJimuLayerId: string, index: number, runtimeAddedDataSource?: DataSource, fromRuntime?: boolean, isRootRuntimeLayer?: boolean): Promise<JimuLayerView>;
    private whenLayerView;
    private onStoreChange;
    /**
     * Return all created JimuTables. This method should be called after `jimuMapView.whenJimuMapViewLoaded()` resolves.
     */
    getJimuTables(): JimuTable[];
    /**
     * @ignore
     * Make sure the currently created JimuTables are loaded.
     */
    loadJimuTables(): Promise<JimuTable[]>;
    /**
     * Return the direct child JimuTables of a given JimuLayerView.
     * @param jimuLayerViewId
     */
    getChildJimuTables(jimuLayerViewId: string): JimuTable[];
    /**
     * The listener will be triggered when JimuTable is created.
     */
    addJimuTableCreatedListener(listener: JimuTableCreatedListener): void;
    /**
     * Remove the JimuTableCreatedListener.
     *
     * @param listener
     */
    removeJimuTableCreatedListener(listener: JimuTableCreatedListener): void;
    private onJimuTableCreated;
    /**
     * @ignore
     */
    createJimuTable(table: __esri.Layer, parentJimuLayerView: JimuLayerView): JimuTable;
    ...
    /**
     * Try to update features of FeatureLayer for show-on-map action. Only updates featureLayer when showOnMapData changed to avoid unnecessary updates.
     */
     ...
     * @param listener
     */
    addCacheListener(listener: JimuMapViewCacheListener): __esri.Handle;
    /**
     * @ignore
     * @param listener
     */
     ...
     * @param listener
     */
    addRestoreListener(listener: JimuMapViewRestoreListener): __esri.Handle;
    /**
     * @ignore
     * @param listener
     */
     ...
     * @ignore
     */
    addUpdatingListener(listener: JimuMapViewUpdatingListener): __esri.Handle;
    /**
     * @ignore
     */
    removeUpdatingListener(listener: JimuMapViewUpdatingListener): void;
    private onDebounceUpdating;
    /**
     * @ignore
     */
    private onUpdating;
     ...
     * @param listener
     */
    addJimuLayerViewSelectedFeaturesChangeListener(listener: JimuLayerViewSelectedFeaturesChangeListener): __esri.Handle;
    /**
     * @ignore
     * @param listener
     */
     ...
     * @param listener
     */
    addSelectByQueryProgressChangeListener(listener: SelectByQueryProgressChangeListener): __esri.Handle;
    /**
     * @ignore
     * @param listener
     */
     ...
     * @param listener
     */
    addJimuLayerViewCreatedListener(listener: JimuLayerViewCreatedListener): __esri.Handle;
    /**
     ...
     * @param listener
     */
    addJimuLayerViewRemovedListener(listener: JimuLayerViewRemovedListener): __esri.Handle;
    /**
     ...
     * @param listener
     */
    addJimuLayerViewsVisibleChangeListener(listener: JimuLayerViewsVisibleChangedListener): __esri.Handle;
    /**
