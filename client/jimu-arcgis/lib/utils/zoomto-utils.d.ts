...
export declare function getExtentFromScale(viewSize: ViewSize, extent: __esri.Extent, scale: number, needToAdjustHeightToAspectRatio?: boolean): Promise<import("esri/geometry/Extent").default>;
