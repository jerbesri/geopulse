import { type DataSourceConstructorOptions, DataSourceTypes, type WMTSDataSource } from 'jimu-core';
import { AbstractDataSource } from '../base-classes/abstract-data-source';
export interface WMTSDataSourceConstructorOptions extends DataSourceConstructorOptions {
    layer?: __esri.WMTSLayer;
}
declare const WMTSDataSourceImpl_base: {
    new (...args: any[]): {
        id: string;
...
export declare class WMTSDataSourceImpl extends WMTSDataSourceImpl_base implements WMTSDataSource {
    layer?: __esri.WMTSLayer;
    type: DataSourceTypes.WMTS;
    constructor(options: WMTSDataSourceConstructorOptions);
    ready(): Promise<void>;
}
export {};
