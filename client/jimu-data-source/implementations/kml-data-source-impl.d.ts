import { type DataSourceConstructorOptions, DataSourceTypes, type KMLDataSource } from 'jimu-core';
import { AbstractDataSource } from '../base-classes/abstract-data-source';
export interface KMLDataSourceConstructorOptions extends DataSourceConstructorOptions {
    layer?: __esri.KMLLayer;
}
declare const KMLDataSourceImpl_base: {
    new (...args: any[]): {
        id: string;
...
export declare class KMLDataSourceImpl extends KMLDataSourceImpl_base implements KMLDataSource {
    layer?: __esri.KMLLayer;
    type: DataSourceTypes.KML;
    constructor(options: KMLDataSourceConstructorOptions);
    ready(): Promise<void>;
}
export {};
