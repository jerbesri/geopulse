...
export declare class SceneLayerDataSourceImpl extends AbstractArcGISQueriableDataSource implements SceneLayerDataSource {
    ...
    getIdField(): string;
    queryById(id: string | number): Promise<FeatureDataRecord>;
    ...
    setPagesData(pages: {
        [page: number]: FeatureDataRecord[];
    }): void;
    getRealQueryPages(page: number, pageSize: number): number[];
    load(query: QueryParams, options?: QueryOptions): Promise<FeatureDataRecord[]>;
    ...
    selectRecordsByIds(ids: string[] | number[], records?: FeatureDataRecord[]): void;
    destroy(): void;
