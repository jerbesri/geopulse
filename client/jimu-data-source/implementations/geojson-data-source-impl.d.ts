import { type DataSourceConstructorOptions, DataSourceTypes, type GeoJSONDataSource } from 'jimu-core';
import { AbstractDataSource } from '../base-classes/abstract-data-source';
export interface GeoJSONDataSourceConstructorOptions extends DataSourceConstructorOptions {
    layer?: __esri.GeoJSONLayer;
}
declare const GeoJSONDataSourceImpl_base: {
    new (...args: any[]): {
        id: string;
...
export declare class GeoJSONDataSourceImpl extends GeoJSONDataSourceImpl_base implements GeoJSONDataSource {
    layer?: __esri.GeoJSONLayer;
    type: DataSourceTypes.GeoJSON;
    constructor(options: GeoJSONDataSourceConstructorOptions);
    ready(): Promise<void>;
}
export {};
