import { type DataSourceConstructorOptions, DataSourceTypes, type WMSDataSource } from 'jimu-core';
import { AbstractDataSource } from '../base-classes/abstract-data-source';
export interface WMSDataSourceConstructorOptions extends DataSourceConstructorOptions {
    layer?: __esri.WMSLayer;
}
declare const WMSDataSourceImpl_base: {
    new (...args: any[]): {
        id: string;
...
export declare class WMSDataSourceImpl extends WMSDataSourceImpl_base implements WMSDataSource {
    layer?: __esri.WMSLayer;
    type: DataSourceTypes.WMS;
    constructor(options: WMSDataSourceConstructorOptions);
    ready(): Promise<void>;
}
export {};
