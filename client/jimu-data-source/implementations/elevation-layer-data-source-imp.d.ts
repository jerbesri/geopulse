import { DataSourceTypes, type DataSourceConstructorOptions, type ElevationLayerDataSource } from 'jimu-core';
import { AbstractDataSource } from '../base-classes/abstract-data-source';
export interface ElevationLayerDataSourceConstructorOptions extends DataSourceConstructorOptions {
    layer?: __esri.ElevationLayer;
}
declare const ElevationLayerDataSourceImpl_base: {
    new (...args: any[]): {
        id: string;
...
export declare class ElevationLayerDataSourceImpl extends ElevationLayerDataSourceImpl_base implements ElevationLayerDataSource {
    layer?: __esri.ElevationLayer;
    type: DataSourceTypes.ElevationLayer;
    constructor(options: ElevationLayerDataSourceConstructorOptions);
    ready(): Promise<void>;
}
export {};
