...
import { type IntlShape, type DataSource, type DataRecordSet, type DataRecord, type DateTimeFieldFormatProperties, type NumberFieldFormatProperties } from 'jimu-core';
/**
...
export declare abstract class AbstractDataRecord implements DataRecord {
    ...
    abstract setId(id: string | number): void;
    ...
    formatDateField(value: any, dateTimeFieldFormat: DateTimeFieldFormatProperties, intl: IntlShape): string;
    formatDateOnlyField(value: string, dateTimeFieldFormat: DateTimeFieldFormatProperties, intl: IntlShape): string;
    formatTimeOnlyField(value: string, dateTimeFieldFormat: DateTimeFieldFormatProperties, intl: IntlShape): string;
    formatNumberField(value: number, numberFieldFormat: NumberFieldFormatProperties, intl: IntlShape): string;
