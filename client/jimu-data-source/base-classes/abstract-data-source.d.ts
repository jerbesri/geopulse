...
export declare abstract class AbstractDataSource implements DataSource {
    ...
    getSelectedRecordIdsFromInfo(): ImmutableArray<string | number>;
    ...
    getSelectedRecordIds(): Array<string | number>;
    /** @deprecated  */
    ...
    getRecordById(id: string | number): DataRecord;
    getSourceRecordById(id: string | number): DataRecord;
    clearSelection(): void;
    ...
    selectRecordById(id: string | number, record?: DataRecord): void;
    selectRecordsByIds(ids: Array<string | number>, records?: DataRecord[]): void;
    protected copySelectionToDataView(selection: DataRecord[]): void;
    getInfo(): IMDataSourceInfo;
    clearRecords(): void;
    clearRecordsNotAddVersion(): void;
    getIdField(): string;
    getUniqueIdFields: () => ImmutableArray<string>;
    ...
    afterDeleteRecordsByIds(ids: Array<string | number>): void;
    afterDeleteRecordById(id: string | number): void;
    protected deleteOneSelectedRecordById(id: string | number): boolean;
    protected deleteOneLoadedRecordById(ds: DataSource, id: string | number): boolean;
    destroy(): void;
}
