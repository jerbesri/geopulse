...
export declare abstract class AbstractQueriableDataSource extends AbstractDataSource implements QueriableDataSource {
    protected _isAGOLHosted: boolean;
    protected _portalSelf: any;
    private lastQueryId;
    ...
    get isAGOLHosted(): boolean;
    set isAGOLHosted(isAGOLHosted: boolean);
    get portalSelf(): any;
    set portalSelf(portalSelf: any);
    ...
    getCurrentQueryId(): string | number;
    ...
    loadById(id: string | number, refresh?: boolean): Promise<DataRecord>;
    ...
    queryById(id: string | number, fields?: string[]): Promise<DataRecord>;
    getAutoRefreshInterval(): number;
    getLastAutoRefreshCheckTime(): number;
    getLastDataLoadTime(): number;
    setLastAutoRefreshCheckTime(time: number): void;
    ...
    protected abstract doQueryById(id: string | number, fields?: string[]): Promise<DataRecord>;
}
