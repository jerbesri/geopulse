...
export function mockItem (mockData: MockItemData) {
  ...
  const portalSelfUrl = `${mockData.portalUrl}/sharing/rest/portals/self`
...
export const MOCK_PORTAL_URL = 'https://mock-portal-url.arcgis.com' // AGOL
export const MOCK_PORTAL_URL2 = 'https://mock-portal-url.portal.com' // portal