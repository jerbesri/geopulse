 ...
 */
export declare const featureCollectionItemWithTwoLayers: MockItemData;
/**
 * Mocked feature collection item. The feature collection item contains one point feature layer.
 */
export declare const featureCollectionItemWithOneLayer: MockItemData;
export declare const featureLayerItemInAGOL: MockItemData;
export declare const featureLayerItemWithProxyHostedInAGOL: MockItemData;
export declare const featureLayerItemWithProxyUnHostedInAGOL: MockItemData;
export declare const featureLayerItemInEnterprise: MockItemData;
