import { type MockItemData, MOCK_PORTAL_URL, MOCK_PORTAL_URL2 } from '../mock-item'
...
const someItemInfo = {
  ...
  owner: 'yuey9507',
  orgId: 'oC086ufSSQ6Avnw2',
  title: 'feature layer item in AGOL',
  name: 'mock_name',
...
export const featureLayerItemInAGOL: MockItemData = {
  portalUrl: MOCK_PORTAL_URL,
  itemId: MOCK_FEATURE_COLLECTION_ITEM_ONE_LAYER_ID,
  itemInfo: {
    ...someItemInfo,
    typeKeywords: ['ArcGIS Server', 'Data', 'Feature Access', 'Feature Service', 'Metadata', 'Service', 'Singlelayer', 'Hosted Service'],
  },
  itemData: {}
}

export const featureLayerItemWithProxyHostedInAGOL: MockItemData = {
  portalUrl: MOCK_PORTAL_URL,
  itemId: MOCK_FEATURE_COLLECTION_ITEM_ONE_LAYER_ID,
  itemInfo: {
    ...someItemInfo,
    typeKeywords: ['ArcGIS Server', 'Data', 'Feature Access', 'Feature Service', 'Service', 'Singlelayer', 'Service Proxy'],
    sourceUrl: 'https://services1.arcgis.com/oC086ufSSQ6Avnw2/arcgis/rest/services/Layer_3_days/FeatureServer',
  },
  itemData: {}
}

export const featureLayerItemWithProxyUnHostedInAGOL: MockItemData = {
  portalUrl: MOCK_PORTAL_URL,
  itemId: MOCK_FEATURE_COLLECTION_ITEM_ONE_LAYER_ID,
  itemInfo: {
    ...someItemInfo,
    typeKeywords: ['ArcGIS Server', 'Data', 'Feature Access', 'Feature Service', 'Service', 'Singlelayer', 'Service Proxy'],
    sourceUrl: 'https://sampleserver6.arcgisonline.com/arcgis/rest/services/SaveTheBay/FeatureServer',
    tags: ['SaveTheBay', 'Service proxy'],
  },
  itemData: {}
}

export const featureLayerItemInEnterprise: MockItemData = {
  portalUrl: MOCK_PORTAL_URL2,
  itemId: MOCK_FEATURE_COLLECTION_ITEM_ONE_LAYER_ID,
  itemInfo: {
    ...someItemInfo,
    typeKeywords: ['ArcGIS Server'],
    sourceUrl: 'https://publicpro121ent.dev.geocloud.com/arcgis/rest/services/SaveTheBay/FeatureServer',
    tags: [],
  },
  itemData: {}
}
