...
export declare class MockMapComponent extends MockAPIAccessor {
    view: MockView;
...
export declare class MockArcGISMapComponent extends MockMapComponent {
}
export declare class MockArcGISSceneComponent extends MockMapComponent {
}
export {};
