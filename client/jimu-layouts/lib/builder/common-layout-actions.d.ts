import { type LayoutItemConstructorProps, type LayoutInfo, type IMAppConfig, type Selection, type ClipboardItem } from 'jimu-core';
export declare function getRootLayoutId(): string;
export declare function updateLayoutAndSelection(appConfig: IMAppConfig, selection: Selection): void;
export declare function pendLayoutItem(layoutInfo: LayoutInfo): void;
export declare function duplicateLayoutItem(layoutInfo: LayoutInfo, autoScroll?: boolean): void;
