/** @jsx jsx */
import { React, type IMThemeVariables, type IntlShape, dateUtils, type EsriDateFormats, type DataSource, EsriFieldType, type DateTimeFieldFormatProperties, type DateWithTimeFieldFormatProperties } from 'jimu-core';
...
export interface DatePickerProps {
    ...
    /**
     * The date format based on Esri field's format.dateFormat.
     * @deprecated Please use `dateFormat` instead.
     * @ignore
     */
    format?: EsriDateFormats | string;
    /**
     * The date format based on Esri field's fieldFormat.
     */
    dateFormat?: DateTimeFieldFormatProperties | DateWithTimeFieldFormatProperties;
    /**
     * Min Date
     * @ignore
     */
...
export declare class _DatePicker extends React.PureComponent<DatePickerProps & ExtraProps & IntlProps, State> {
    ...
    getEsriFieldType: (dateFormat: any) => EsriFieldType.Date | EsriFieldType.DateOnly;
