...
interface CustomStepProps {
    ...
    /**
     * Selector for an element to automatically focus when the step becomes active.
     * This is useful for accessibility, allowing keyboard users to immediately interact with the highlighted element.
     */
    focusTarget?: string;
    /**
