...
export declare const Chart: React.NamedExoticComponent<Omit<ChartProps, "ref"> & React.RefAttributes<import("@arcgis/charts-components/dist/components/arcgis-chart/customElement").ArcgisChart>>;
export * from './utils';
