...
export interface SketchContextStates {
    ...
    getGraphicsLayerFunRef: () => __esri.GraphicsLayer | __esri.MapNotesLayer;
...
export declare const SketchContextProvider: (props: any) => import("@emotion/react/jsx-runtime").JSX.Element;
export {};
