...
import type { JimuPointSymbol, JimuPolylineSymbol, JimuPolygonSymbol, JimuTextSymbol, JimuSymbol, JimuSymbolType, DrawingElevationMode3D } from '../../../../../';
...
export declare const SketchAPI: React.MemoExoticComponent<(props: SketchAPIProps) => import("@emotion/react/jsx-runtime").JSX.Element>;
