...
export type CategoriesType = 'New and noteworthy' | '3D' | 'People' | 'Environment' | 'Tourism' | 'Infrastructure' | 'Data' | 'Document' | 'Business Analyst' | 'Accessibility';
...
export declare const FIRST_NEW_VERSION_OF_PORTAL = "1.19.0";
