import { type WidgetJson, type IMThemeVariables, type IntlShape, type ImmutableObject, type ImmutableArray, type Expression, type ClauseValuePair, type IMDynamicStyleConditionValueOptions, type IMDynamicStyleConditionInfo, type DynamicStyleConditionInfo, type IMDynamicTextStyle, type IMSingleConditionStyleConfig, type IMDynamicIconStyle, type IMDynamicBorderStyle, type IMDynamicStyle, type IMConditionStyleConfig, type IMDynamicStyleConfig, type DataSource, type IMFieldSchema, type CodedValue, type IMDynamicBackgroundStyle } from 'jimu-core';
...
export declare function getDefaultIMBackgroundStyle(): IMDynamicBackgroundStyle;
