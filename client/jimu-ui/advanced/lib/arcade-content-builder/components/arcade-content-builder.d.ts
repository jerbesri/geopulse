/** @jsx jsx */
import { React, type ImmutableArray, type UseDataSource, type IMArcadeContentConfig, ArcadeContentCapability, type IMDynamicStyleTypes, type IMDynamicStyleEditorOptions } from 'jimu-core';
...
export interface ArcadeContentBuilderProps {
    ...
    /**
     * @ignore
     * Indicates whether the component is used for adding custom Arcade fields.
     */
...
}, "config" | "widgetId" | "useDataSources" | "className" | "onChange" | "capabilities" | "forwardedRef" | "repeatedDataSource" | "dynamicStyleTypes" | "dynamicStyleEditorOptions" | "usedForArcadeField" | "useTitle" | "useIcons" | "modalOnly" | "insertMode" | "onModalClose"> & {
