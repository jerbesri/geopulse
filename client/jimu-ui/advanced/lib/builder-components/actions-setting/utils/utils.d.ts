 ...
 * Note: `dataSourceId` is only needed when adding a message for a data source from global scope.
*/
export declare const getNewMessage: (messageType: MessageType, widgetId?: string, dataSourceId?: string) => MessageJson;
...
*/
export declare const getNewActionItem: (target: IMWidgetJson | IMSectionJson | FrameWorkTargetJson, action: MessageAction, messageOwnerId: string, messageType: MessageType, isFrameWorkMessage?: boolean) => MessageActionJson;
/**
