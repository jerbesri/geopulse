...
export interface FrameworkDsSelectorSourceDataParams {
...
export declare function getFrameworkDsSelectorSourceData(props: FrameworkDsSelectorSourceDataParams): DsSelectorSource;
