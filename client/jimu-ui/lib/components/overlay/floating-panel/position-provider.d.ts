...
import { type AutoPlacementOptions, type FlipOptions, type HideOptions, type OffsetOptions, type Placement, type ShiftOptions, type Strategy } from '../popper/core';
...
export interface PositionProviderProps {
    ...
    /**
     * The hide options can hide the floating panel when the reference is hidden.
     ...
     */
    children: React.ReactElement<FloatingPanelChildrenProps & {
        ref: React.Ref<HTMLDivElement>;
        'data-version': number;
    }>;
}
export declare const PositionProvider: React.NamedExoticComponent<PositionProviderProps & React.RefAttributes<HTMLDivElement>>;
