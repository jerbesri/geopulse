import { type IMAppConfig, type IMAttributesJson, type IMCustomThemeJson, type IMDataSourceJson, type IMDialogJson, type IMLayoutJson, type IMMessageJson, type IMPageJson, type IMViewJson, type IMSectionJson, type IMWidgetJson, type LayoutInfo, LayoutItemType, LayoutType, type IMSizeModeLayoutJson, BrowserSizeMode, type Size, type DataSourceJson, type WidgetJson, type IMProxyJson, type IMScreenGroupJson, type IMScreenJson, type IMUtilitiesJson, type UtilityJson, LayoutParentType, type ControllerPanelJson, type UrlParamsConfig, type Analytics, type CookieBannerJson, type AppStateConfig, type TranslationJson, type Translation, type AppResourceList, type SavedTheme } from 'jimu-core';
...
export declare class AppConfigAction {
   ...
   */
    ...
    setDefaultView(sectionId: string, viewId: string): this;
    ...
    private updatePageRestrictionsAfterRemovePage;
    ...
    editSavedThemes(savedThemes: SavedTheme[]): this;
    editSavedThemeSelectedId(savedThemeSelectedId?: string): this;
    replaceOldThemeVariables(): Promise<this>;
    ...
    updateTranslationJsons(translationJsons: {
        [locale: string]: TranslationJson;
    }): this;
    updateTranslations(translations: Translation[], translationJsons: {
        [locale: string]: TranslationJson;
    }): this;
    /**
     * Updates the list of translation values that have been modified.
     *
     * @param changedTranslationValues - An array of identifiers or keys for translation values that were changed.
     * @returns The current action instance, to allow method chaining.
     */
    updateChangedTranslationValues(changedTranslationValues: string[]): this;
    updateAppResourceList(appResourceList: AppResourceList): this;
