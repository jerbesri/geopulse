...
export declare const DataSourceSelectionGuide: ReactRedux.ConnectedComponent<(props: GuideProps & StateToProps) => import("@emotion/react/jsx-runtime").JSX.Element, {
    className?: string;
    disabled?: boolean;
    params?: any;
    steps: Steps;
