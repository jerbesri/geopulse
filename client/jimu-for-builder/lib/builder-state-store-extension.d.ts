...
interface BuilderState {
    ...
    /**
     * Whether the builder is currently in the translation-panel configuration flow.
     */
    isConfiguringTranslations?: boolean;
    /**
     * Incremented after translation-panel close cleanup has finished.
     */
    translationConfigCloseVersion?: number;
}
...
declare enum ActionKeys {
    ...
    ConfiguringTranslationsChanged = "CONFIGURING_TRANSLATIONS_CHANGED",
    TranslationConfigCloseCompleted = "TRANSLATION_CONFIG_CLOSE_COMPLETED"
}
...
export interface ConfiguringTranslationsChangedAction extends UnknownAction {
    type: ActionKeys.ConfiguringTranslationsChanged;
    isConfiguring: boolean;
}
export interface TranslationConfigCloseCompletedAction extends UnknownAction {
    type: ActionKeys.TranslationConfigCloseCompleted;
}
type ActionTypes = SelectTemplateAction | WidgetSettingClassLoadedAction | WidgetsAddedAction | WidgetsRemovedAction | RefreshAppListAction | ChangeCurrentAppAction | WidgetSettingI18nMessageLoadedAction | ConfirmDeleteContentChangedAction | MessageActionSettingOpenStateChangeAction | ConfiguringTranslationsChangedAction | TranslationConfigCloseCompletedAction;
...
declare const actions: {
    ...
    configuringTranslationsChanged: (isConfiguring: boolean) => ConfiguringTranslationsChangedAction;
    translationConfigCloseCompleted: () => TranslationConfigCloseCompletedAction;
};
