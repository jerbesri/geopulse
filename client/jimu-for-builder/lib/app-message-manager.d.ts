import { React, type MessageManager, type MessageType, type MessageAction, type ActionSettingProps, type IMMessageActionJson } from 'jimu-core';
export default class AppMessageManager {
     ...
     */
    getActionSettingComponentUri(action: MessageAction, messageType: MessageType, messageWidgetId?: string, messageDataSourceId?: string): string;
    getFilteredActions(messageType: MessageType, messageWidgetId?: string, messageDataSourceId?: string): MessageAction[];
