export declare enum ToAppMessage {
    ...
    BuilderWebTierResourcesChanged = "builder_web_tier_resources_changed",
    ...
    RuntimeThemeModeChange = "runtime_theme_mode_change",
    ChangeDynamicStylePreviewConditionInfo = "change_dynamic_style_preview_condition_info",
    ChangePreviewLocale = "change_preview_locale",
...
export declare enum ToBuilderMessage {
    ...
    AppWebTierResourcesChanged = "app_web_tier_resources_changed",
