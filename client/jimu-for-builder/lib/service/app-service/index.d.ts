...
import { type AppCreationInfo, type AppConfig, type IMAppConfig, type TranslationJson } from 'jimu-core';
...
export { createAppByItemTemplateInfo, createAppByItemTemplateId, createAppByDefaultTemplate, createTemplateByApp, duplicateAppByAppId } from './create-app-or-template';
/**
...
export declare const getAppConfigForSave: (appConfig: IMAppConfig) => IMAppConfig;
...
export declare const getConfigTranslationJsonsForPublish: (draftAppConfig: AppConfig) => Promise<{
...
export declare function updateAppInfo(itemParam: IItemUpdate, owner: string): Promise<void>;
export declare function updateIsViewerCopiable(id: string, isViewerCopiable: boolean, owner: string): Promise<import("@esri/arcgis-rest-portal").IUpdateItemResponse>;
...
export declare function unpublishApp(appInfo: AppInfo): Promise<AppInfo>;
export declare function discardDraftChanges(appInfo: AppInfo): Promise<AppInfo>;
