...
/**
 * Create a ReferencePaletteColor from a TonalPalette.
 * @param input The TonalPalette input.
 * @param tones The tones to generate colors for. Default is ReferencePaletteColorTones.
 * @returns The generated ReferencePaletteColor.
 */
export declare const createPaletteColorFromTones: (input: TonalPalette, tones?: number[]) => ReferencePaletteColor;
